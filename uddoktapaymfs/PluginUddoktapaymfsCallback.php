...
class PluginUddoktaPayMfsCallback extends PluginCallback
{
    public function processCallback()
    {
        $cPlugin = new Plugin('', 'uddoktapaymfs', $this->user);
        $apiKey = trim($cPlugin->GetPluginVariable("plugin_uddoktapaymfs_API KEY"));
        $apiBaseURL = trim($cPlugin->GetPluginVariable("plugin_uddoktapaymfs_API URL"));
        ...
        $exchangeRate = !empty($cPlugin->GetPluginVariable("plugin_uddoktapaymfs_Exchange Rate")) ? $cPlugin->GetPluginVariable("plugin_uddoktapaymfs_Exchange Rate") : 1;
        ...
        $cPlugin = new Plugin($invoiceId, 'uddoktapaymfs', $this->user);
